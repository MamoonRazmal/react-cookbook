...
export default function Breakfast_Landing_Page(){
    return(
        ...
        <NavLink to={"/breakfast/frenchfries"}  id="nav"   activeClassName="active">  French Fries</NavLink>
        <NavLink to={"/breakfast/sandwhich"}  id="nav"  activeClassName="active">Sandwhich</NavLink>
